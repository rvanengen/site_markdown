from site_markdown.crawler import Page, CrawlResult, extract_page, normalize_url, render_document


def test_normalize_url_removes_query_fragment_and_trailing_slash():
    assert normalize_url("HTTPS://Example.COM/docs/?q=1#top") == "https://example.com/docs"
